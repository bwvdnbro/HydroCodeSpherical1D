...
plot("instability_t10.txt", ax)
plot("instability_t20.txt", ax)
plot("instability_t40.txt", ax)
plot("instability_t80.txt", ax)
...
fp = np.memmap("instability_radius.dat", dtype = 'd', mode = 'r')
...
pl.plot(data[:, 0] / yr_in_si, data[:, 1] / au_in_si)
pl.xlabel("$t$ (yr)")
pl.ylabel("$R_I$ (AU)")
pl.tight_layout()
